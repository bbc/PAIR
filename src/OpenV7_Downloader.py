...
def download_all_images(args):
  ...
  download_folder = args['openv7_download_folder'] or os.getcwd()
  ...
  try:
    image_list = list(
        check_and_homogenize_image_list(
            read_image_list_file(args['download_list'])))
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      help='Number of parallel processes to use (default is CPU count).')
